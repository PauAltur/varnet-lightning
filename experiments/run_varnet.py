...
parser.add_argument(
    ...
    type=int,
    default=24,
    help="number of filter for convolutional kernel",
)
parser.add_argument(
    "--num_act_weights",
    type=int,
    default=31,
    help="number of RBF kernel for activation function",
)
parser.add_argument(
...
parser.add_argument(
    ...
    type=str,
    default="rbf",
    help="activation function to use (rbf or relu)",
)
...
parser.add_argument(
    "--save_dir",
    type=str,
    default="logs\\basic_varnet",
    help="directory of the experiment",
)
parser.add_argument(
    "--momentum", type=float, default=0.0, help="momentum for the optimizer"
)
parser.add_argument(
    "--loss_weight", type=float, default=1.0, help="weight for the loss function"
)
parser.add_argument(
    "--error_scale",
    type=float,
